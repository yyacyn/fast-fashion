            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-8 pt-8 border-t border-[var(--border)] flex flex-col md:flex-row justify-between items-center">
                    ...
                    <p className="text-xs text-[var(--muted-foreground)]">
                        Anargya Rabbani Aslam, Muhamad Mauladi Fadillah, Rival Fitrah Dermawan, Siti Laila Nurjannah, Yashin Al Fauzy Sabara
                    </p>
                    </div>
                    <div className="flex space-x-6 mt-4 md:mt-0">
                        <a href="https://web.facebook.com/argya.raslam" className="text-[var(--muted-foreground)] hover:text-[var(--primary)]">
                        ...
                        <a href="https://www.instagram.com/arbaretsukloghert/" className="text-[var(--muted-foreground)] hover:text-[var(--primary)]">
                        ...
                        <a href="https://x.com/phoneinflames" className="text-[var(--muted-foreground)] hover:text-[var(--primary)]">
